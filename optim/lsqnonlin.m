...
%
%   LSQNONLIN implements two different algorithms: trust region reflective and 
...
try
    dataType = superiorfloat(xCurrent,LB,UB);
catch ME
...
if ~strcmp(dataType,'double')
    error(message('optim:lsqnonlin:NonDoubleInput'))
end
